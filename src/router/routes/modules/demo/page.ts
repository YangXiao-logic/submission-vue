...
import { ExceptionEnum } from '../../../../../../../vue-vben-admin/src/enums/exceptionEnum';
import { t } from '../../../../../../../vue-vben-admin/src/hooks/web/useI18n';

const ExceptionPage = () => import('../../../../../../../vue-vben-admin/src/views/sys/exception/Exception.vue');
      ...
      children: [
        {
          path: 'basic',
          name: 'FormBasicPage',
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/form/basic/index.vue'),
          meta: {
        ...
        },
        {
          path: 'step',
          name: 'FormStepPage',
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/form/step/index.vue'),
          meta: {
        ...
        },
        {
          path: 'high',
          name: 'FormHightPage',
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/form/high/index.vue'),
          meta: {
      ...
      children: [
        {
          path: 'basic',
          name: 'DescBasicPage',
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/desc/basic/index.vue'),
          meta: {
        ...
        },
        {
          path: 'high',
          name: 'DescHighPage',
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/desc/high/index.vue'),
          meta: {
      ...
      children: [
        {
          ...
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/result/success/index.vue'),
          meta: {
        ...
        },
        {
          path: 'fail',
          name: 'ResultFailPage',
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/result/fail/index.vue'),
          meta: {
      ...
      children: [
        {
          ...
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/account/center/index.vue'),
          meta: {
        ...
        },
        {
          ...
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/account/setting/index.vue'),
          meta: {
      ...
      children: [
        {
          path: 'basic',
          name: 'ListBasicPage',
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/list/basic/index.vue'),
          meta: {
        ...
        },
        {
          path: 'card',
          name: 'ListCardPage',
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/list/card/index.vue'),
          meta: {
        ...
        },
        {
          path: 'search',
          name: 'ListSearchPage',
          component: () => import('../../../../../../../vue-vben-admin/src/views/demo/page/list/search/index.vue'),
          meta: {
